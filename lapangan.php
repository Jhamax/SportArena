...
<main class="flex-grow-1">
    ...
    <section class="public-field-page">
        <div class="container">
                ...
                <div class="row align-items-center gy-3">
                    <div class="col-lg-8">
                        ...
                        <h1 class="fw-bold mb-2">
                            Lihat daftar lapangan sebelum membuat akun.
                        </h1>

                        <p class="mb-0">
                            Pengunjung dapat melihat jenis lapangan, fasilitas, harga per jam,
                            dan status ketersediaan. Untuk melakukan booking, pengguna perlu login terlebih dahulu.
                        </p>
                    </div>
                    ...
                    <div class="col-lg-4 text-lg-end">
                        <?php if (!$is_login) : ?>
                            <a href="register.php" class="btn btn-light fw-semibold px-4">
                                Register untuk Booking
                            </a>
                        <?php elseif ($role === 'user') : ?>
                            <a href="user/lapangan.php" class="btn btn-light fw-semibold px-4">
                                Masuk Halaman Booking
                            </a>
                        <?php elseif ($role === 'admin') : ?>
                            <a href="admin/lapangan.php" class="btn btn-light fw-semibold px-4">
                                Kelola Lapangan
                            </a>
                        <?php endif; ?>
                    </div>
            ...
            <?php if (!$is_login) : ?>
                <div class="login-note">
                    ...
                    Kamu bisa melihat daftar lapangan tanpa login. Namun untuk melihat detail booking,
                    memilih jadwal, dan melakukan reservasi, kamu harus login atau register terlebih dahulu.
                </div>
            <?php endif; ?>
                            ...
                            <div class="field-card">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        ...
                                        <?php elseif ($is_login && $role === 'admin') : ?>

                                            <a 
                                                href="admin/edit_lapangan.php?id=<?= $lapangan['id_lapangan']; ?>" 
                                                class="btn btn-success"
                                            >
                                                Kelola
                                            </a>
